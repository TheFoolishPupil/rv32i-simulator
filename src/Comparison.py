...
for test_file in names1:
    error=os.system("C:\\Users\\natha\\AppData\\Local\\Programs\\Python\\Python310\\python.exe main.py --program ..\\tests\\task1\\" +test_file+".bin")
    ...
    if error:
        ...
        same=filecmp.cmp("..\\tests\\task1\\"+test_file+".res","..\\tests\\task1\\"+test_file+"_.res")
        if not same:
            complete=0
            print("\n" + test_file + " failed")
        else:
...
for test_file in names2:
    error=os.system("C:\\Users\\natha\\AppData\\Local\\Programs\\Python\\Python310\\python.exe main.py --program ..\\tests\\task2\\" +test_file+".bin")
    if error:
        complete=0
        print("Error, Program Crashed")
    else:
        #If it is executed without error, we check the result.
        same=filecmp.cmp("..\\tests\\task2\\"+test_file+".res","..\\tests\\task2\\"+test_file+"_.res")
        if not same:
            complete=0
            print("\n" + test_file + " failed")
        else:
...
for test_file in names3:
    error=os.system("C:\\Users\\natha\\AppData\\Local\\Programs\\Python\\Python310\\python.exe main.py --program ..\\tests\\task3\\" +test_file+".bin")
    if error:
        complete=0
        print("Error, Program Crashed")
    else:
        #If it is executed without error, we check the result.
        same=filecmp.cmp("..\\tests\\task3\\"+test_file+".res","..\\tests\\task3\\"+test_file+"_.res")
        if not same:
            complete=0
            print("\n" + test_file + " failed")
        else:
